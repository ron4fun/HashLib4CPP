...
{
	IPBKDF2_HMAC PBKDF2 = HashLib4CPP::PBKDF2_HMAC::CreatePBKDF2_HMAC(hash, Password, Salt, 2048);
...
BOOST_AUTO_TEST_CASE(TestOne)
{
	HashLibByteArray Key = HashLib4CPP::PBKDF2_HMAC::CreatePBKDF2_HMAC(hash, Password, Salt, 100000)->GetBytes(32);

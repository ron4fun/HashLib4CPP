...
const string ChunkedData = "HashLib4Pascal012345678HashLib4Pascal012345678HashLib4Pascal012345678HashLib4Pascal012345678";
const string EmptyData = "";
const string DefaultData = "HashLib4Pascal";
const string ShortMessage = "A short message";
const string ZerotoFour = "01234";
const string OnetoNine = "123456789";
const string RandomStringRecord = "I will not buy this record, it is scratched.";
const string RandomStringTobacco = "I will not buy this tobacconist's, it is scratched.";
const string QuickBrownDog = "The quick brown fox jumps over the lazy dog";
const HashLibByteArray Bytesabcde = HashLibByteArray({ 0x61, 0x62, 0x63, 0x64, 0x65 });
const string HexStringAsKey = "000102030405060708090A0B0C0D0E0F";
const string HMACLongStringKey = "I need an Angel";
const string HMACShortStringKey = "Hash";
...
// HashCloneIsCorrectTestHelper Variables
...
void HashCloneIsCorrectTestHelper(const IHash hash)
{
	...
	BOOST_CHECK(ExpectedString == ActualString, 
		Utils::string_format('%s CloneIsCorrectTest -> Expected %s but got %s.', hash->GetName(), ExpectedString, ActualString));
}

void HashCloneIsUnique(const IHash hash)
{
	IHash Original = hash, Copy;
	...
	BOOST_CHECK(Original->GetBufferSize() != Copy->GetBufferSize(),
		Utils::string_format("%s CloneIsUniqueTest -> Expected %d but got %d.", hash->GetName(), Original->GetBufferSize(), Copy->GetBufferSize()));
}

void HMACCloneIsCorrect(const IHash hash)
{
	IHash hash2 = hash;
	IHMAC Original, Copy;
	...
	BOOST_CHECK(ExpectedString == ActualString,
		Utils::string_format('%s HMACCloneIsCorrectTest -> Expected %s but got %s.', hash->GetName(), ExpectedString, ActualString));
}

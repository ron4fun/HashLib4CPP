...
class Tiger : public BlockHash, public IICryptoNotBuildIn, public IITransformBlock
{
public:
	virtual IHash Clone() const
	{
		Tiger HashInstance = Tiger(hash_size, GetHashRound(rounds));
		HashInstance.hash = hash;
		HashInstance.buffer = make_shared<HashBuffer>(buffer->Clone());
		HashInstance.processed_bytes = processed_bytes;

		IHash hash = make_shared<Tiger>(HashInstance);
...
protected:
	Tiger(const int32_t a_hash_size, const HashRounds &a_rounds)
...
const uint64_t Tiger::T1[256] = { uint64_t(0x02AAB17CF7E90C5E),
...
const uint64_t Tiger::T2[256] = { uint64_t(0xE6A6BE5A05A12138),
...
const uint64_t Tiger::T3[256] = { uint64_t(0xF49FCC2FF1DAF39B),
...
const uint64_t Tiger::T4[256] = { uint64_t(0x5B0E608526323C55),
...
class Tiger_3_128 : public Tiger
{
public:
	Tiger_3_128()
		: Tiger(16, Rounds3)
	{} // end constructor
}; // end class Tiger_3_128


class Tiger_4_128 : public Tiger
{
public:
	Tiger_4_128()
		: Tiger(16, Rounds4)
	{} // end constructor
}; // end class Tiger_4_128


class Tiger_5_128 : public Tiger
{
public:
	Tiger_5_128()
		: Tiger(16, Rounds5)
	{} // end constructor
}; // end class Tiger_5_128


class Tiger_3_160 : public Tiger
{
public:
	Tiger_3_160()
		: Tiger(20, Rounds3)
	{} // end constructor
}; // end class Tiger_3_160


class Tiger_4_160 : public Tiger
{
public:
	Tiger_4_160()
		: Tiger(20, Rounds4)
	{} // end constructor
}; // end class Tiger_4_160


class Tiger_5_160 : public Tiger
{
public:
	Tiger_5_160()
		: Tiger(20, Rounds5)
	{} // end constructor
}; // end class Tiger_5_160


class Tiger_3_192 : public Tiger
{
public:
	Tiger_3_192()
		: Tiger(24, Rounds3)
	{} // end constructor
}; // end class Tiger_3_192


class Tiger_4_192 : public Tiger
{
public:
	Tiger_4_192()
		: Tiger(24, Rounds4)
	{} // end constructor
}; // end class Tiger_4_192


class Tiger_5_192 : public Tiger
{
public:
	Tiger_5_192()
		: Tiger(24, Rounds5)
	{} // end constructor
}; // end class Tiger_5_192


class Tiger_Base : public Tiger
{
public:
	Tiger_Base(const int32_t a_hash_size, const HashRounds &a_rounds)
